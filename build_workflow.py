...
connections = {
    "WhatsApp Trigger": {
        "main": [[{"node": "Normalize Incoming", "type": "main", "index": 0}]]
    },
    "Normalize Incoming": {
        "main": [[{"node": "Supabase Get User", "type": "main", "index": 0}]]
    },
    "Supabase Get User": {
        "main": [[{"node": "Classify User", "type": "main", "index": 0}]]
    },
    "Classify User": {
        "main": [[{"node": "Route User", "type": "main", "index": 0}]]
    },
    "Route User": {
        "main": [
    ...
    "Create User Record": {
        "main": [[{"node": "Send Step 1 Prompt", "type": "main", "index": 0}]]
    },
    ...
    "Update Step 1 Response": {
        "main": [[{"node": "Send Step 2 Prompt", "type": "main", "index": 0}]]
    },
    "Update Step 2 Response": {
        "main": [[{"node": "Send Step 3 Prompt", "type": "main", "index": 0}]]
    },
    "Update Step 3 Response": {
        "main": [[{"node": "Send Step 4 Prompt", "type": "main", "index": 0}]]
    },
    "Update Step 4 Response": {
        "main": [[{"node": "Generate Personalized Plan", "type": "main", "index": 0}]]
    },
    "Generate Personalized Plan": {
        "main": [[{"node": "Format Plan Output", "type": "main", "index": 0}]]
    },
    "Format Plan Output": {
        "main": [[{"node": "Insert Habits", "type": "main", "index": 0}]]
    },
    "Insert Habits": {
        "main": [[{"node": "Complete Onboarding", "type": "main", "index": 0}]]
    },
    "Complete Onboarding": {
        "main": [[{"node": "Send Plan Summary", "type": "main", "index": 0}]]
    },
    "Detect Confirmation": {
    ...
    "Fetch Pending Habit": {
        "main": [[{"node": "Upsert Habit Log", "type": "main", "index": 0}]]
    },
    "Upsert Habit Log": {
        "main": [[{"node": "Send Celebration", "type": "main", "index": 0}]]
    },
    "Fetch Active Habits": {
        "main": [[{"node": "Fetch Today Progress", "type": "main", "index": 0}]]
    },
    ...
    "Build Agent Context": {
        "main": [[{"node": "AI Agent Reply", "type": "main", "index": 0}]]
    },
    "AI Agent Reply": {
    ...
    "Fetch Reminder Candidates": {
        "main": [[{"node": "Filter Reminder Window", "type": "main", "index": 0}]]
    },
